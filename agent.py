...
def get_agent(player: str, strategy: str) -> BaseAgent:
    ...
    if strategy == "random":
        ...
        if StudentAgentCpp:
            ...
            return StudentAgent(player)
    elif strategy == "friend_cpp":
        try:
            import friend_agent_cpp as friend_agent
            FriendAgentCpp = friend_agent.StudentAgent
        except ImportError as e :
            print(e)
            print("Import error")
            FriendAgentCpp = None
        if FriendAgentCpp:
            return FriendAgentCpp(player)
        else:
            print("C++ FriendAgent not available. Falling back to Python StudentAgent.")
            return StudentAgent(player)
    else:
